    ...
    with st.container():
        ...
        def update_record():
            ...
            if (
                ...
                #update_syntax_middle_values.append(st.session_state["beyazperde_link_new"])
                obj = my_functions.MyClass()
            ...
            # manuel update alanına ait güncelleme de yapılacak eğer herhangi bir güncelleme oldu ise
